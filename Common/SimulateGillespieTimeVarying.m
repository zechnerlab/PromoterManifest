function [X, t, r, H, G, cVarying] = SimulateGillespieTimeVarying(X0, c, Pre,...
                    Post, N, maxTime, tvRateIndex, funHandle, params, startTime)
    ...
    for i=1:N
       ...
       c(tvRateIndex) = funHandle(t(i), params); %0.005*
