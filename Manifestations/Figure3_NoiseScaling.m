...
selPromoters = {'DCS2', 'TKL2', 'SIP18', 'pSIP18_mut6', 'pSIP18_mut21'};
%selPromoters = {'SIP18'};
...
for u=1:30
    ...
    for i=1:length(selPromoters)
        ...
        % remove outliers
        %nonOutlierIdx = abs(transcrOutput-mean(transcrOutput)) < 3*std(transcrOutput);
        %transcrOutput = transcrOutput(nonOutlierIdx);
