%This file generates synthetic gene expression responses from a given three
%state model. This is used to test the accuracy of the algorithm (see
%folder '../SyntheticData/'.
...
fileName = sprintf('Promoter_s%d_synData.mat', promoterSpeed);
save(fileName);
