function [Mu, Sigma, pActivated, p2, p3, meanTauS, meanTauA, meanNumSwitches, meanTr, varTr, q5Tr, q95Tr, meanTrOutput, meanRSwitches, meanTauState, ZMat] = ProcessCellReconstruction(model, particles, tGrid, maxZ)
    ...
    q5Tr = quantile(ZMat, 0.05, 1);
    q95Tr = quantile(ZMat, 0.95, 1);
