...
%In this case, only the switching rates of the promoter are re-estimated,
%all other parameters are take from the previous runs corresponding to the
%Msn2 concentration, respectively.
...
config.UnknownHIdx = [];
config.UnknownMIdx = [];
%config.UnknownZIdx = []; %do not re-estimate transcription rates
